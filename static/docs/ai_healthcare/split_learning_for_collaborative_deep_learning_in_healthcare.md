...
두 번째 강점은 **두 개의 서로 다른 의료영상 과제에서 일관된 결과**를 보여줬다는 점이다. 안저영상 binary classification과 흉부 X-ray multi-label classification은 성격이 꽤 다른 과제인데, दोनों에서 split learning이 비협업보다 우수했다. 이는 방법의 적용 가능성이 꽤 넓다는 정성적 근거가 된다.
