...
본 보고서는 다음과 같은 3 차元的 관점에서 문헌을 정리한다.
...
| 중速 (20~40 FPS) | 38~49 FPS   | Efficient Global-Local Memory: 38 FPS | mDice 61%, MI_DSC 44.7%  |
| 저速 (<20 FPS)   | 4~15 FPS    | MATIS Frame: 15 FPS                   | mIoU↑ (84.26%)           |
